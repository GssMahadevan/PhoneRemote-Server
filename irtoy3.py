...
# GSS Mahadevan 2016
#
# Hacked original code ( by above for USB-Ir-Toy code) to suite Capturing/Reading
# writing to  USB IrToy-v2
# Working properly -- though cost of the USB-IrToy is 19$ versus 3.5$ ESP-IR-Sending.
# 
# Modifications done to original module:
# * Though unstable/still-needs-to-be-tested
#  * Remove some handshake for continious sending/receiving
#  * Remove some extra sleeping to allow fast IR sending like 3 digit channel numbers
#  * Don't use for production/mission-crtiical projects without extemsive testing
#  * Renamed from original irtoy.py to irtoy3 to reduce name space polluting& related conflicts  
